...
### BinanceChain.request\({method: "eth\_sign", params: \["address", "message"\]\) <a id="binancechainrequestmethod-eth_sign-params-address-message"></a>
...
### BinanceChain.request\({method: "eth\_accounts"}\) <a id="binancechainrequestmethod-eth_accounts"></a>
...
function App() {
  ...
  return (
    Binance Chain Connector
      {status === 'disconnected' ? (
         onClick={() => connect('bsc')}>Connect
      ) : (
         onClick={() => reset()}>Disconnect
      )}
...
### BinanceChain.chainId <a id="binancechainchainid"></a>
...
### BinanceChain.autoRefreshOnNetworkChange <a id="binancechainautorefreshonnetworkchange"></a>
...
### BinanceChain.isConnected\(\) <a id="binancechainisconnected"></a>
...
### BinanceChain.request\(args\) <a id="binancechainrequestargs"></a>
...
### BinanceChain.bnbSign\(address: string, message: string\): Promise&lt;{publicKey: string, signature: string}&gt; <a id="binancechainbnbsignaddress-string-message-string-promisepublickey-string-signature-string"></a>

_We prepared an example for this API, please check out: https://github.com/binance-chain/js-eth-personal-sign-examples for more detail_
...
### BinanceChain.switchNetwork\(networkId: string\): Promise&lt;{networkId: string}&gt; <a id="binancechainswitchnetworknetworkid-string-promisenetworkid-string"></a>
...
### BinanceChain.requestAccounts\(\) <a id="binancechainrequestaccounts"></a>
...
### BinanceChain.transfer\({fromAddress:string, toAddress:string, asset:string, amount:number, memo?: string, sequence?: number, accountId:string, networkId:string}\)&gt; <a id="binancechaintransferfromaddressstring-toaddressstring-assetstring-amountnumber-memo-string-sequence-number-accountidstring-networkidstring"></a>
...
1. This will ask the user's approval for transferring 1 BNB to himself. `BinanceChain.transfer({fromAddress:"tbnb1sndxdzsg42jg8lc0hehx8dzzpyfxrvq937mt0w", toAddress:"tbnb1sndxdzsg42jg8lc0hehx8dzzpyfxrvq937mt0w", asset:"BNB", amount:1, accountId:"fba0b0ce46c7f79cd7cd91cdd732b6c699440acf8c539d7e7d753d38c9deea544230e51899d5d9841b8698b74a3c77b79e70d686c76cb35dca9cac0e615628ed", networkId:"bbc-testnet"})`
2. This will ask the user's approval for transferring 1 BUSD to himself. `BinanceChain.transfer({fromAddress:"tbnb1sndxdzsg42jg8lc0hehx8dzzpyfxrvq937mt0w", toAddress:"tbnb1sndxdzsg42jg8lc0hehx8dzzpyfxrvq937mt0w", asset:"BUSD-BAF", amount:1, accountId:"fba0b0ce46c7f79cd7cd91cdd732b6c699440acf8c539d7e7d753d38c9deea544230e51899d5d9841b8698b74a3c77b79e70d686c76cb35dca9cac0e615628ed", networkId:"bbc-testnet"})`
...
### BinanceChain.networkVersion \(DEPRECATED\) <a id="binancechainnetworkversion-deprecated"></a>
...
### BinanceChain.selectedAddress \(DEPRECATED\) <a id="binancechainselectedaddress-deprecated"></a>
...
### BinanceChain.enable\(\) \(DEPRECATED\) <a id="binancechainenable-deprecated"></a>
...
### BinanceChain.sendAsync\(\) \(DEPRECATED\) <a id="binancechainsendasync-deprecated"></a>
...
### BinanceChain.send\(\) \(DEPRECATED\) <a id="binancechainsend-deprecated"></a>
