...
* [A minimalist tutorial on writing your runtime pallet in its own package](https://substrate.dev/docs/en/tutorials/create-a-pallet/).
* With your node now capable of running smart contracts, go learn about [Substrate ink! smart contracts](https://substrate.dev/docs/en/knowledgebase/smart-contracts/).
...
* Understand the [Chain Spec](https://substrate.dev/docs/en/knowledgebase/integrate/chain-spec) file to customize your Genesis Configuration.
