...
```text
getTransactionFromBlock(BlockHash, indexNumber [, callback])
```
...
```text
getTransactionFromBlock("0xfb8d7ee8fb5f4fbebf41a55caa5e988a480a0ce277813cd1ec4443c54f601ddd",0).then(console.log)
> {
